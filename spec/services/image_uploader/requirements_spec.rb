...
RSpec.describe ImageUploader::Requirements do
  describe "#errors" do
    it "returns an empty array when a valid image is uploaded" do
      ...
      errors = ImageUploader::Requirements.new(uploaded_file).errors
      expect(errors).to be_empty
    end

    it "returns an error when no image is specified" do
      errors = ImageUploader::Requirements.new(nil).errors
