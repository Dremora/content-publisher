...
RSpec.describe ImageUploader::Normaliser do
  ...
  describe "#normalised_file" do
    it "returns a tempfile" do
      normaliser = ImageUploader::Normaliser.new(file_fixture("960x640.jpg"))
    ...
    it "fixes orientation and strips exif data" do
      ...
      normaliser = ImageUploader::Normaliser.new(source_path)
